...
## Цель проекта
Показать аккуратную UI-витрину на React + Tailwind и продемонстрировать алгоритмическую генерацию тренировок без бэкенда — как портфолио-проект/витрина для Yandex Cup.
